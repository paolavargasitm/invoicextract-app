  ...
  return (
    <div style={{ display: "grid", gap: 16 }}>
      <section style={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: 12, padding: 16 }}>
        ...
        <div style={{ color: "var(--muted)" }}>Gestiona el flujo de facturas desde un solo lugar.</div>
      </section>
      ...
      <section style={{ display: 'grid', gridTemplateColumns: 'repeat( auto-fit, minmax(280px, 1fr) )', gap: 16 }}>
        {(isFinanzas) && (
          <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 12, padding: 16 }}>
            ...
            <div style={{ color: 'var(--muted)' }}>Consulta métricas, estados y exporta reportes consolidados de facturación.</div>
        ...
        {(isTecnico) && (
          <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 12, padding: 16 }}>
            ...
            <div style={{ color: 'var(--muted)' }}>Administra los mapeos de extracción.</div>
            <div style={{ marginTop: 12 }}>
        ...
        {(isTecnico) && (
          <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 12, padding: 16 }}>
            ...
            <div style={{ color: 'var(--muted)' }}>Configura los ERPs disponibles.</div>
            <div style={{ marginTop: 12 }}>
        ...
        {isAdmin && (
          <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 12, padding: 16 }}>
            ...
            <div style={{ color: 'var(--muted)' }}>Administra las credenciales y parámetros de correo para automatización.</div>
            <div style={{ marginTop: 12 }}>
