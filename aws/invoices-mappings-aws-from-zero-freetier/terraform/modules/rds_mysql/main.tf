...
# ------------------------------------------------------------
# Security Group for RDS (allow 3306 only from allowed CIDR)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# RDS Instance (MySQL Free Tier pinned)
# ------------------------------------------------------------
resource "aws_db_instance" "this" {
  ...
  multi_az            = false
  publicly_accessible = true   # Dev only – restricts access to your IP
